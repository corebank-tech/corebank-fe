              ...
              <div className="flex w-full flex-col gap-2">
                ...
                {emailIssued != null && !emailVerified && (
                  <div className="flex items-center gap-2 rounded-md border border-border bg-surface px-3 py-2">
                    <span
                      className={`font-tabular text-lg font-bold tracking-2 ${emailExpired ? "text-ink-faint line-through" : "text-primary"}`}
                      aria-label="발송된 이메일 인증번호"
                    >
                      {emailIssued}
                    </span>
                    <span
                      className={`font-tabular text-base font-bold ${emailExpired ? "text-ink-faint" : "text-ink"}`}
                    >
