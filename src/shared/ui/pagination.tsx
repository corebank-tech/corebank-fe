      ...
      {pages.map((p) => {
        ...
        return (
          <button
            ...
            className={cn(
              "inline-flex h-9 min-w-9 items-center justify-center rounded-md border px-2 text-base whitespace-nowrap focus-visible:ring-2 focus-visible:ring-ring focus-visible:outline-none",
              active
