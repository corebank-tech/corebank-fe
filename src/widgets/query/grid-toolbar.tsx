...
type GridToolbarProps = React.HTMLAttributes<HTMLDivElement> & {
   ...
   * 이 prop은 제거하고 서버 페이징 화면도 "전체 보기"를 되살린다. 클라이언트가
   * 전체 목록을 들고 페이지 크기로 잘라 쓰는 화면(B-03·D-04·F-02)은 기본값
   * 그대로 두면 된다. B-01은 `pageSize`를 이 툴바에 넘기기만 하고 목록을 자르는
   * 데 쓰지 않아 어느 값을 골라도 결과가 같다 — 별개의 기존 문제다.
   */
