...
type GridToolbarProps = React.HTMLAttributes<HTMLDivElement> & {
   ...
   * 이 prop은 제거하고, 지금 `false`를 넘기는 서버 페이징 화면 6개
   * (B-03·D-04·E-04·E-05·G-04·G-05)가 "전체 보기"를 되살린다. 클라이언트가 전체
   * 목록을 들고 페이지 크기로 잘라 쓰는 화면(F-02)은 기본값 그대로 두면
    ...
    <div className={cn("mb-2 flex flex-col gap-1", className)} {...props}>
      <div className="flex items-end justify-between gap-4">
        ...
        <div className="flex shrink-0 items-center gap-1.5">
          ...
          <Select
            id="grid-page-size"
            className="h-8 w-[108px] text-base"
